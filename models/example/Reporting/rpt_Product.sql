...
inner join {{ ref("dim_employee")}} as a12 on a11.employeeid = a12.empid
inner join {{ ref('dim_customer')}} as a13 on a11.customerid = a13.customer_id
inner join {{ ref('dim_Products')}} as a14 on a11.productid = a14.product_id
